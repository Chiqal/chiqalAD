...
#client = LineClient()
#client = LineClient(id='YOUR_EMAIL', passwd='YOUR_PASS')
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada','hai kak','aloo..','nah','lg ngapain','halo','sini kak','sini kak','cieee','bintit loh kak','gabung aja kak','sini turun','hmmmm','phiwwiitt','turun atuh','aduuuh','hellaawww','come here']
